...
public class ReceivePatientTriageRequestBehaviour extends CyclicBehaviour {
    ...
    public ReceivePatientTriageRequestBehaviour(Agent agent, QueueManagerAgent queueManager) {
    ...
    public void action() {
        ...
        if (doctorAgent.getCurrentPatientId() == null) {
            // Prendi il paziente direttamente dalla coda del QueueManager
            Map.Entry<String, it.unige.dibris.mas.ontology.TriageColor> patientEntry = queueManager.getNextPatient();
